                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1"
                                            src="{{ asset('dashboard-assets/app-assets/images/slider/slider-2.png') }}"
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span class="avatar avatar-online">
                                <img src="{{ asset('dashboard-assets/app-assets/images/portrait/small/avatar-s-19.png') }}"
                                    alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown"
                            ...
                            <i class="flag-icon flag-icon-{{ $currentLocale == 'en' ? 'gb' : $currentLocale }}"></i>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            @foreach ($supportedLocales as $localeCode => $properties)
                                <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                    ...
                                    {{-- علم --}}
                                    @php
                                        // خريطة بسيطة عشان flag-icon بتستخدم كود دولة مش كود لغة
                                        $flagMap = [
                                            'en' => 'gb',
                                            'ar' => 'eg',
                                            'fr' => 'fr',
                            ...
                            <li class="scrollable-container media-list w-100">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-busy rounded-circle">
                                                <img src="{{ asset('dashboard-assets/app-assets/images/portrait/small/avatar-s-2.png') }}"
                                                    alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="{{ asset('dashboard-assets/app-assets/images/portrait/small/avatar-s-3.png') }}"
                                                    alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                                <img src="{{ asset('dashboard-assets/app-assets/images/portrait/small/avatar-s-6.png') }}"
                                                    alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
